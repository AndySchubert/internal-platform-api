...
describe('AuthService', () => {
    ...
    it('should logout and navigate to login', () => {
        ...
        httpMock.expectOne(`${environment.apiUrl}/api/v1/auth/login`).flush({});
        httpMock.expectOne(`${environment.apiUrl}/api/v1/auth/me`).flush(mockUser);
    ...
    it('should verify email', () => {
        ...
        const req = httpMock.expectOne(`${environment.apiUrl}/api/v1/auth/verify-email`);
