...
def send_verification_email(email: str, token: str) -> None:
    ...
    logger.info(f"Click here to verify: http://localhost:4200/verify-email?token={token}")
    logger.info(f"==========================================\n")
...
def send_password_reset_email(email: str, token: str) -> None:
    ...
    logger.info(f"Click here to reset: http://localhost:4200/reset-password?token={token}")
    logger.info(f"==========================================\n")
